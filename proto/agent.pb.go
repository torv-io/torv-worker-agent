...
const (
	...
	RequestType_REQUEST_TYPE_HANDLE_STAGE_START  RequestType = 4
	RequestType_REQUEST_TYPE_HANDLE_STAGE_FINISH RequestType = 5
)
...
var (
	RequestType_name = map[int32]string{
		...
		4: "REQUEST_TYPE_HANDLE_STAGE_START",
		5: "REQUEST_TYPE_HANDLE_STAGE_FINISH",
	}
...
type AgentRequest_HandleStageStart struct {
	HandleStageStart *HandleStageStartBody `protobuf:"bytes,5,opt,name=handle_stage_start,json=handleStageStart,proto3,oneof"`
}

type AgentRequest_HandleStageFinish struct {
	HandleStageFinish *HandleStageFinishBody `protobuf:"bytes,6,opt,name=handle_stage_finish,json=handleStageFinish,proto3,oneof"`
}
...
func (x *WorkItemBody) GetRunnerType() string {
	if x != nil {
		return x.RunnerType
	}
	return ""
...
func (x *WorkItemBody) GetCodePresignedUrl() string {
	if x != nil {
		return x.CodePresignedUrl
	}
	return ""
}

func (x *WorkItemBody) GetConfigPresignedUrl() string {
	if x != nil {
		return x.ConfigPresignedUrl
	}
	return ""
}
...
const file_proto_agent_proto_rawDesc = "" +
	...
	"\fcontext_json\x18\x06 \x01(\tR\vcontextJson*\xd1\x01\n" +
	...
	"\x1eREQUEST_TYPE_STAGE_RUN_MESSAGE\x10\x03\x12#\n" +
	"\x1fREQUEST_TYPE_HANDLE_STAGE_START\x10\x04\x12$\n" +
	" REQUEST_TYPE_HANDLE_STAGE_FINISH\x10\x05*\x89\x01\n" +
...
var file_proto_agent_proto_goTypes = []any{
	...
	(*RegisterResponseBody)(nil),        // 9: agent.RegisterResponseBody
